...
@Mod(modid=RandomMobEvents.MODID, name=RandomMobEvents.MODNAME, version=RandomMobEvents.VERSION, acceptableRemoteVersions = "*")
...
public class RandomMobEvents {
	...
	public static final String VERSION = "1.8.9-1.0.5";
