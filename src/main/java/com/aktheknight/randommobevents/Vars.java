...
public class Vars {
	...
	public static int creeperConfusion;
	public static int creeperDigSlow;
	public static int creeperHarm;
	...
	public static int spiderConfusion;
	public static int spiderDigSlow;
	public static int spiderHarm;
	...
	public static int zombieConfusion;
	public static int zombieDigSlow;
	public static int zombieHarm;
	...
	public static int skeletonConfusion;
	public static int skeletonDigSlow;
	public static int skeletonHarm;
	...
	public static int caveSpiderConfusion;
	public static int caveSpiderDigSlow;
	public static int caveSpiderHarm;
